...
func (uu *UserUpdate) AddCompanyIDs(ids ...uuid.UUID) *UserUpdate {
...
func (uu *UserUpdate) RemoveCompanyIDs(ids ...uuid.UUID) *UserUpdate {
...
// AddCompanyIDs adds the "companies" edge to the Company entity by IDs.
func (uuo *UserUpdateOne) AddCompanyIDs(ids ...uuid.UUID) *UserUpdateOne {
...
// RemoveCompanyIDs removes the "companies" edge to Company entities by IDs.
func (uuo *UserUpdateOne) RemoveCompanyIDs(ids ...uuid.UUID) *UserUpdateOne {
