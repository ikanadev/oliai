...
func (tx *Tx) init() {
	tx.BlockCategory = NewBlockCategoryClient(tx.config)
	tx.BlockInfo = NewBlockInfoClient(tx.config)
...
// applies a query, for example: BlockCategory.QueryXXX(), the query will be executed
